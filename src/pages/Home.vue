<template>
  <!-- <dropdown text="Click me" placement="top">
    ...
    <section class="permission_denied">
      <vue-particles
            id="tsparticles"
  ...
  <div class="denied__wrapper">
    ...
    <svg id="astronaut" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
      ...
      <g class="st10">
        <path d="M249.5 465v1c.6 8.8 1.5 7.2-8.3 7.1h-7.8c1.5-1.9 1.8-2.4 1.8-5.1v-1.1c0-14.1-5.3-26.9-13.7-36.2-5.5-6-12.3-10.3-19.8-12.7.8 0 1.6.1 2.4.1 13.1.8 26.6 5.6 34.7 14.2 8.1 8.6 10.7 19.9 10.7 32.7z" class="st5"></path>
      </g>
