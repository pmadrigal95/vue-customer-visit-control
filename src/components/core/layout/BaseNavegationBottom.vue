<template>
            ...
            <div class="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
                <button type="button"
                    ...
                    <span
                        class="text-sm text-blue800 group-hover:text-orange900">Clientes</span>
                </button>
                <button type="button"
                    class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
                    <svg class="w-5 h-5 mb-2 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500"
                ...
                <button type="button"
                    ...
                    <span
                        class="text-sm text-blue800 group-hover:text-orange900">Compresores</span>
            </button>
            <button type="button"
                class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
                <svg class="w-5 h-5 mb-2 text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500"
                ...
                <span
                        class="text-sm text-blue800 group-hover:text-orange900">Reportes</span>
            </button>
        </div>
    </div>
</template>