    ...
    <div id="drawer-disabled-backdrop"
        ...
        <div class="py-4 overflow-y-auto">
            <ul class="space-y-2 font-medium">
                <li> <router-link class="flex items-center p-2 text-blue900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group" :to="{ name: 'Home' }">
          ...
          <li>
            <router-link class="flex items-center p-2 text-blue900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group" :to="{ name: 'Logout' }">
                <svg class="flex-shrink-0 w-5 h-5 text-orange900 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 16">
